...
async function saveRoom(event){
    ...
    await user_ref.update({
        anunturi_postate: fire.firestore.FieldValue.arrayUnion(anunt_ref.id)
    })
...
<section class="flex flex-col max-w-xl mt-10 mx-auto">
    ...
    <form class:hidden={!show_btn} on:submit|preventDefault|once={saveRoom} class="flex flex-col gap-2">
        ...
        <Box autoCompleteList={localitati} name="locatie_add" label="Oras si zona" placeholder="ex: Iasi, Cantemir">
